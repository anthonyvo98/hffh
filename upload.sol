...
contract syncZilla is ERC20, Ownable {
    ...
    constructor() ERC20("Muhammad Ali", "ALI") {
        ...
        marketingWallet = address(0xeA8b8A9857cE828616c082058E04F0DD63D91a43); // set as marketing wallet
        devWallet = address(0xeA8b8A9857cE828616c082058E04F0DD63D91a43); // set as dev wallet
    ...
    function setPools(address pool) public onlyOwner {
        ...
        IMuteSwitchRouterDynamic _uniswapV2Router = IMuteSwitchRouterDynamic(0xB3b7fCbb8Db37bC6f572634299A58f51622A847e); 
