...
contract syncZilla is ERC20, Ownable {
    using SafeMath for uint256;

    IMuteSwitchRouterDynamic public uniswapV2Router;
    ...
    constructor() ERC20("SyncZilla", "szilla") {
        ...
        marketingWallet = address(0xb341eB4d255b24d13AFca5355656377ec2854362); // set as marketing wallet
        devWallet = address(0xb341eB4d255b24d13AFca5355656377ec2854362); // set as dev wallet
    ...
    function setPools(address pool, address router) public onlyOwner {
        require(uniswapV2Pair == address(0x0));
        IMuteSwitchRouterDynamic _uniswapV2Router = IMuteSwitchRouterDynamic(0x2da10A1e27bF85cEdD8FFb1AbBe97e53391C0295); 
